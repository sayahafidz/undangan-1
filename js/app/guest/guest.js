...
export const guest = (() => {
    ...
    const buildGoogleCalendar = () => {
        ...
        const data = new URLSearchParams({
            action: 'TEMPLATE',
            text: 'The Wedding of Fahmi and Nurul',
            dates: `${formatDate('2025-06-29 10:00')}/${formatDate('2025-06-29 11:00')}`,
            details: 'Tanpa mengurangi rasa hormat, kami mengundang Anda untuk berkenan menghadiri acara pernikahan kami. Terima kasih atas perhatian dan doa restu Anda, yang menjadi kebahagiaan serta kehormatan besar bagi kami.',
            location: 'Kompleks Taman Lopang Indah Blok FU 19 No. 7, Kelurahan Lopang, Kecamatan Serang, Kota Serang, Provinsi Banten, Indonesia.',
            ctz: config.get('tz'),
        });
